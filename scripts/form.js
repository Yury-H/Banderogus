...
const openFormModalBtn = document.querySelector('#open-form-modal-button');
const launchBtn = document.querySelector('#banderogus-button');
...
function showGooseAnim() {
    ...
    gusImage.setAttribute('src', './img/img/gus-anim.gif');
